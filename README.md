...
![alt text](images/new_warehouse_avoidance_gif.gif "Collision avoidance using Nav2")
...
<img src="images/forklift_pc_front.png"  height="50%" width="50%">
</p>
...
<img src="images/workflow_with_segmentation.PNG"  height="50%" width="50%">
...
6. In a new terminal, follow Step 2 from [Running the pipeline](https://gitlab-master.nvidia.com/asawareeb/isaac-ros-nav2#running-the-pipeline) to build and source the packages. Run the Segmentation node in this terminal:
   ...
   <img src="images/segmentation_mask.PNG"  height="50%" width="50%">
